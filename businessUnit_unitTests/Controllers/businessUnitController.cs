...
namespace businessUnit.Controllers
{
    ...
    public class businessUnitController : ControllerBase  // it is always inherited from the controller base class
    {
        ...
        [Route("GetDetailsofBusinessUnit")]  // multiplr URL for same resourses
        ...
        [HttpGet]
        [Route("GetBusinessUnitsById/{id : min(100)}")] // GetBusinessUnitsById is a hardcodevalue and id is a dynamic value and is represented inside {} and min shws that the id must has a limit of 100
        ...
        [HttpPost]
        [Route("SaveOrder")]
        public IActionResult Post([FromBody] businessUnitModel details)
        {
            try
            {
                ResponseType type = ResponseType.Success;
        ...
        public IActionResult Patch(int id,[FromBody] businessUnitModel details)
        {
            try
            {
                //ResponseType type = ResponseType.Success;
